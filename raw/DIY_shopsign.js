...
let shopname=''
const token=[
  'E00D6A459AF649E41861EFA90C3140AA',//4.7日添加7天5 15天10 30天20
  'EA6849B8D31E3FA7074B5CB308D9F61B',//4.14日添加5天3
  'E2B0E9E2ADE3E71D75895FCED3DCB0A9',//4.14日添加7天10
  '2CE2E0FCC76E39F86E0C39EBB2D5360C',//4.14日添加14天100
  '64EDCB1DDE5AFD3DCB539CBF42C32033',//4.15日添加2天3，5天3
  '6FDCBC46346DC686AFE738F809D3A0BA',//4.16日添加5天1
  'BFD7ADD288D6384CC02B11F5EA10077E',//4.17日添加 15天50
  '80275409F23292506BFDCEFC7819BF97',//4.17日添加5天10  15天20
  '212DA2ED7042289F4E524432EF97A0D6',//4.17日添加5天100
  'AE6A399CC6542115869E4BC9929D050E',//4.18日添加1天2 3天5 7天10
  '8575162A3824F0B9D2CC9E6522AF9BD4',//4.18日添加3天3  7天10 14天15
]
//IOS等用户直接用NobyDa的jd cookie
...
if ($.isNode()) {
  ...
  cookiesArr.reverse();
  cookiesArr.push(...[$.getdata('CookieJD2'), $.getdata('CookieJD'), $.getdata('CookieJD3')]);
  cookiesArr.reverse();
  ...
  return new Promise(resolve => {
    const options = {
      ...
      headers: {
        ...
        "User-Agent": `jdapp;iPhone;9.3.5;13.3;30237e5bd84daafb6130603aabc879684da1efe6;network/wifi;ADID/6764CB45-D575-49B8-BE39-51434A8C8A1C;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone8,1;addressid/2049812564;supportBestPay/0;appBuild/167515;jdSupportDarkMode/0;pv/26.2;apprpd/Home_Main;ref/JDMainPageViewController;psq/1;ads/;psn/30237e5bd84daafb6130603aabc879684da1efe6|63;jdv/0|kong|t_1003849861_|tuiguang|8d2d7af74dbf49d68acc249610d27664|1611411474;adk/;app_device/IOS;pap/JA2015_311210|9.3.5|IOS 13.3;Mozilla/5.0 (iPhone; CPU iPhone OS 13_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1`
      }
    }
